...
console.log('⚡ CoinKe V2.0 (15dk & Futures) Aktif! (NewBot - 15m Hunter)');
...
function scheduleNextScan() {
    ...
    console.log(`⏰ Bir sonraki 15dk tarama ${new Date(nextScan).toLocaleTimeString()} saatinde yapılacak.`);
    setTimeout(async () => {
        await performScan();
        scheduleNextScan();
    }, delay);
